...
// import NoticePa from './container/parent/NoticePa';
// import NoticeAdDetailPa from './container/parent/notice/NoticeAdDetailPa';
// import NoticeTeDetailPa from './container/parent/notice/NoticeTeDetailPa';
...
// import HomeworkDetailTe from './container/teacher/homework/HomeworkDetail';
// import SubmitDetaiTe from './container/teacher/homework/SubmitDetail';
      ...
      <BrowserRouter>
        <Suspense fallback={<div>로딩 중...</div>}>
          <Routes>
            ...
            <Route
              path='/main/noticeSt/adminDetail/:id'
              element={<NoticeAdDetailSt />}
            />
            <Route
              path='/main/noticeSt/teacherDetail/:id'
              element={<NoticeTeDetailSt />}
            />
            <Route path='/main/homeworkSt' element={<HomeworkSt />} />
            <Route
              path='/main/homeworkSt/homeworkDetail/:id'
            ...
            <Route
              path='/main/noticeAd/noticeAdNewWrite'
              element={<NoticeAdNewWrite />}
            />
            <Route
              path='/main/noticeAd/noticeAdWrite/:id'
              element={<NoticeAdWrite />}
            />
            ...
            <Route
              path='/main/homeworkTe/homeworkTeNewWrite'
              element={<HomeworkTeNewWrite />}
            />
            <Route
              path='/main/homeworkTe/homeworkTeWrite/:id'
              element={<HomeworkTeWrite />}
            />
            <Route
              path='/main/homeworkTe/HomeworkDetail/:id'
              element={<HomeworkDetailTe />}
            />
            <Route
              path='/main/homeworkTe/HomeworkDetail/:homeworkId/submit/:submitId'
              element={<SubmitDetaiTe />}
            />
            <Route path='/main/noticeTe' element={<NoticeTe />} />
            <Route
              path='/main/noticeTe/adminDetail/:id'
              element={<NoticeAdDetailTe />}
            />
            <Route
              path='/main/noticeTe/teacherDetail/:id'
              element={<NoticeTeDetailTe />}
            />
            <Route
              path='/main/noticeTe/noticeTeNewWrite'
              element={<NoticeTeNewWrite />}
            />
            <Route
              path='/main/noticeTe/noticeTeWrite/:id'
              element={<NoticeTeWrite />}
            />
          </Routes>
        </Suspense>
      </BrowserRouter>
