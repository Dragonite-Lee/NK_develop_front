...
const Footer = () => {
  return ( 
<<<<<<< HEAD
    <footer className="w-full flex tablet:flex-row mobile:flex-col tablet:items-start mobile:items-start justify-between desktop:px-[222px] desktop:py-[38px] tablet:px-[24px] tablet:[24px] mobile:px-[20px] mobile:py-[38px] tablet:gap-0 mobile:gap-[20px] bg-border h-auto">
=======
