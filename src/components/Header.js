    ...
    return (
      <>
        <header className="min-w-[280px] headerBorder desktop_header:px-[222px] tablet_header_change:px-[40px] mobile:px-[20px] py-[20px] flex items-center justify-between">
          ...
          <img src={List} alt="listbar" onClick={() => setSidebar(true)} className="w-[32px] h-[32px] mobile:block tablet_header_change:hidden" />
        </header>
        {sidebar && (
          <MobileMenu student_route={student_route} teacher_route={teacher_route} parent_route={parent_route} admin_route={admin_route}
