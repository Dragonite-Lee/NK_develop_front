...
const MobileMenu = ({student_route, teacher_route, parent_route, onClick, role, pathname, sidebar}) => {
    

  return (
    <div>
      <div className="transition-all w-screen tablet_change:hidden h-screen bg-black opacity-50 fixed top-0 z-10" onClick={onClick}></div>
      <div className={`w-[37%] h-screen tablet_change:hidden bg-whiteTotal opacity-100 fixed top-0 right-0 z-20`}>
