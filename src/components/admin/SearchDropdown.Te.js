...
import { useAdAllTeacherQuery } from "./query";
  ...
  return ( 
    <div className="relative">
      <div className="relative tablet:w-[167px] mobile:w-[127px] h-[36px]" onClick={() => setTrigger(!trigger)}>
        <input readOnly type="text" value={value} onChange={setValue} placeholder="김수학" className="caret-transparent font-nanum_400 tablet:text-[14px] mobile:text-[12px] tablet:w-[167px] mobile:w-[127px] h-[36px] border border-border rounded-[10px] placeholder-grey"/>
