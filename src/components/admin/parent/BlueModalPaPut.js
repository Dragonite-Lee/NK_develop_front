        ...
        <div className="tablet:text-[14px] mobile:text-[12px] font-nanum_700 flex tablet_change:flex-row flex-col items-start justify-between tabelt_change:gap-[30px] mobile:gap-[17px] mt-[24px] tablet:px-[40px] mobile:px-[20px] ">
          <div className="flex flex-col gap-[17px] tablet_change:w-[292px] tablet:w-[303px] mobile:w-[220px]">
            <div className="flex items-center justify-between">
              <div>
                학부모 이름 <span className="text-error">*</span>
              </div>
              <input
                type="text"
                value={nicknameValue}
            ...
            <div className="relative z-20 flex items-center justify-between">
              <div>
                자녀와의 관계 <span className="text-error">*</span>
              </div>
              <DropdownMenu
                state={relationshipValue}
                setState={setRelationship}
                itemData={relationList}
              />
            </div>
            <div className="relative z-10 flex items-center justify-between">
              ...
              <SearchDropdownSt
                state={studentIds}
                setState={setStudentIds}
                value={studentIdsValue}
                setValue={setStudentIdsValue}
              />
            </div>
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="flex flex-col gap-[17px] tablet_change:w-[292px] tablet:w-[303px] mobile:w-[220px]">
            <div>
              <div className="flex items-center justify-between">
                <div>
                  학부모 연락처 <span className="text-error">*</span>
                </div>
                <input
                  type="tel"
            ...
            <div>
              <div className="flex items-center justify-between">
                <div>
                  학부모 아이디 <span className="text-error">*</span>
                </div>
                <input
                  type="text"
                  value={usernameValue}
            ...
            <div>
              <div className="flex items-center justify-between">
                <div>
                  학부모 비밀번호 <span className="text-error">*</span>
                </div>
                <input
                  type="password"
                  placeholder="홍길동"
