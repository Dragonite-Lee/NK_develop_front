...
const LoginInfo = () => {
  return ( 
    <section className="tablet:mt-[35px] mobile:mt-0 tablet:mb-[60px] mobile:mb-[24px]">
      <div className="px-[30px] py-[27px] desktop:w-[588px] w-full glassWhite">
        <p className="font-paybooc_500 tablet:text-sm mobile:text-[14px] text-black leading-[23px]">
      ...
      <div className="flex tablet:flex-row mobile:flex-col items-center justify-between tablet:gap-6 mobile:gap-[24px] mt-6 font-paybooc_700">
        <div className="mobile:px-[30px] tablet:px-[33px] desktop:px-[30px] py-[26px] rounded-[20px] bg-management2 desktop:w-[282px] h-[156px] w-full">
          ...
          <p className="tablet:text-[20px] mobile:text-[19px] flex justify-end">매일 13:00 ~ 22:00</p>
        </div>
