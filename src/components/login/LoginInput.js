...
const LoginInput = () => {
  ...
  return (
    <section className="tablet:w-full desktop:w-[486px] flex justify-center items-center h-[460px] glassWhite">
      <div>
        <div className="font-nanum_700 text-[28px]">로그인</div>
        <div className="flex items-center justify-center gap-[10px] text-[16px] mt-[19px] mb-[33px] font-nanum_700 text-[16px] desktop:w-[330px] tablet:w-[488px] h-[58px] bg-main4 rounded-[37px]">
          {role && role.map((item) => {
            return (
