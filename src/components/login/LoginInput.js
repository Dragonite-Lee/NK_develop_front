  ...
  return (
    <section className="mobile:w-full desktop:w-[486px] flex justify-center items-center tablet:h-[460px] mobile:h-full glassWhite tablet:p-0 mobile:p-[13px]">
      <div className="mobile:w-full tablet:w-auto">
        <div className="font-nanum_700 tablet:text-[28px] mobile:text-[20px] tablet:block mobile:flex justify-center">
          로그인
        </div>
        <div className="flex items-center justify-center tablet:p-0 mobile:p-[5px] tabelt:mx-0 mobile:mx-[8px] gap-[10px] mobile:text-[12px] tablet:mt-[19px] mobile:mt-[16px] tablet:mb-[33px] mobile:mb-[12px] font-nanum_700 tablet:text-[16px] desktop:w-[330px] tablet:w-[488px] mobile:w-auto tablet:h-[58px] mobile:h-[43px] bg-main4 rounded-[37px]">
          {role &&
            role.map((item) => {
              return (
                <button
                  className={`flex items-center justify-center desktop:w-[100px] tablet:w-[150px] mobile:w-full tablet:h-[48px] mobile:h-[33px] rounded-[37px]
                ${
                  item.default === true
                    ? " font-nanum_700 bg-main3"
                    : " font-nanum_400 hover:bg-main3/50"
                }
                `}
        ...
        <div className="flex flex-col gap-[8px] items-center justify-center">
          ...
          />
          <button
            className={`tablet:mt-[30px] mobile:mt-[4px] font-nanum_700 text-[15px] desktop:w-[282px] tablet:w-[440px] mobile:w-full h-[49px] rounded-[30px] text-white 
            ${
              emailValue !== "" && pwValue !== ""
                ? " bg-main3 hover:bg-main3/50 active:bg-main2 cursor-pointer"
                : " bg-grayLight cursor-auto"
            }`}
