...
const DropdownSt = ({ state, setState, itemData, setId }) => {
  ...
  return (
    <div className="relative z-10">
      <div
        className="relative tablet:w-[344px] mobile:w-[220px] h-[56px]"
      ...
      >
        <input
          ...
          onChange={setState}
          placeholder="선택하세요"
          className="indent-[22px] caret-transparent font-paybooc_500 tablet:text-[16px] mobile:text-[14px] tablet:w-[344px] mobile:w-[220px] h-[56px] border border-border rounded-[20px] placeholder-grey"
        />
        {trigger ? (
          <img
            src={CaretUp}
            alt="화살표"
            className="w-[22px] h-[22px] absolute top-[18px] right-[22px]"
          />
        ) : (
          <img
            src={CaretDown}
