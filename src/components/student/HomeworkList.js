    ...
    <section className="tablet:mt-[35px] mobile:mt-[30px] tablet:mb-[60px] mobile:mb-[24px]">
      <div className="tablet:px-[222px] mobile:px-[30px] justify-center items-center">
        ...
        <div className="w-[fit-content] glassWhite flex justify-end ml-auto">
          <p className="text-[13px] flex items-center justify-end px-[10px] font-nanum_500">
            <SelectOption />
          </p>
        </div>
          ...
          {Dummy_student.map((item, index) => (
            <div key={index} className="flex-row justify-between mt-[15px] mb-[15px]">
              <div className="flex items-start mt-[6px]">
                <p className="text-[13px] font-nanum_700">{item.work}</p>
                <p className="text-[13px] flex justify-end font-nanum_400 ml-auto ]">{item.status}</p>
              </div>
              <div className="flex items-start mt-[6px]">
                <p className="text-[12px] text-gray mb-[15px] font-nanum_700">{item.name}</p>
                <p className="text-[12px] text-gray flex justify-end font-nanum_400 ml-auto mb-[15px]">{item.date}</p>
              </div>
