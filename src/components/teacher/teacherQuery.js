...
export const useTeClassroomStudentQuery = (id) => {
  const { data, isLoading } = useQuery(['/teacher/classroom/student', id],() =>
...
export const useTeAllClassNoticeQuery = (classnameId) => {
  const { data, isLoading } = useQuery(['/teacher/class-notice', classnameId],() =>
...
export const useTeAdminNoticeQuery = (classnameId, page,keyword,type) => {
  const { data, isLoading } = useQuery(['/teacher/class-notice', classnameId, page, keyword, type],() =>
...
export const useTeOneAdminNoticeQuery = (classnameId, noticeId) => {
  const { data, isLoading } = useQuery(['/teacher/class-notice/one', classnameId, noticeId],() =>
