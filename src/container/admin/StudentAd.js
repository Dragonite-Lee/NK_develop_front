...
const StudentAd = () => {
  ...
  return (
    <>
      ...
      {registerModal && <BlueModalSt setState={setRegisterModal} />}
      {schoolRegisterModal && (
      ...
      {classRegisterModal &&
        (selection?.length !== 0 && selection?.length !== undefined ? (
          <BlueModalStCl
            setState={setClassRegisterModal}
            selection={selection}
          />
        ) : (
          <YellowModal
      ...
      <div className="min-w-[280px]">
        ...
        <main className="desktop:w-[996px] desktop:mx-auto tablet:w-auto tablet:mx-[40px] mobile:mx-[20px] pt-[28px] pb-[58px] mainHeight">
          ...
          <div className="flex items-center justify-end gap-[16px] mt-[8px]">
            <div>
              <div
                onClick={() => setClassRegisterModal(true)}
                className="flex items-center justify-center gap-[4px] w-[109px] h-[36px] rounded-[10px] bg-management2"
              >
                <img
            ...
            <div>
              <div
                onClick={() => setSchoolRegisterModal(true)}
                className="flex items-center justify-center gap-[4px] w-[109px] h-[36px] rounded-[10px] bg-management2"
              >
                <img
                  src={circle_plus_white}
