...
const TeacherAd = () => {
  ...
  return (
    <>
      {cancleModal &&
        (selection?.length !== 0 ? (
          <YellowModal
            ...
            title="선생님 정보 삭제"
            content1="선택한 "
            content2={`${selection?.length}명의 선생님`}
            content3="을 삭제하시겠습니까?"
            cancle="취소하기"
            del="삭제하기"
          />
      ...
      {registerModal && <BlueModalTe setState={setRegisterModal} />}
          ...
          <div className="mt-[13px] flex flex-wrap items-center justify-end gap-[16px]">
            <div className="relative">
              <input
                ...
                className="w-[300px] h-[36px] text-[14px] font-nanum_400 pl-[15px] rounded-[10px] bg-whiteTotal drop-shadow-sm"
              />
              <button
            ...
            <div>
              <div
                ...
                className="flex items-center justify-center gap-[4px] w-[118px] h-[36px] rounded-[10px] bg-management2"
              >
                <img
