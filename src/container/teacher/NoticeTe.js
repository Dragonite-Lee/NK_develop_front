...
const NoticeTe = () => {
  ...
  const totalNotice =
    allAdminNoticeData?.data.length + allClassNoticeData?.data.length;
          ...
          {allClassNoticeData && (
            <>
              <div className="flex items-center justify-between mt-[32px]">
                ...
                <Link to="/main/noticeTe/noticeTeNewWrite">
              ...
              <AdClNoticeTable
                ...
                adminNotice={allAdminNoticeData.data}
                keyword={keyword}
                type={type}
              />
            </>
